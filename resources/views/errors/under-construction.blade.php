...
<body class="bg-[#0b0f19] text-gray-300 min-h-screen flex flex-col items-center justify-between p-6 md:p-12 relative overflow-hidden font-sans">
    <!-- Background glow elements -->
    <div class="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-brand-green/10 blur-[120px] pointer-events-none"></div>
    <div class="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-blue-500/10 blur-[120px] pointer-events-none"></div>
    ...
    <header class="w-full max-w-6xl flex justify-center md:justify-start z-10">
        <div class="flex items-center gap-3">
            ...
            <span class="text-xl font-bold text-white tracking-wider">PT. BERKAH CIPTA PERSADA</span>
        </div>
    </header>
    ...
    <main class="max-w-2xl text-center flex flex-col items-center my-auto z-10 px-4">
        ...
        <div class="relative mb-8">
            <div class="absolute inset-0 bg-brand-green/20 rounded-full blur-md animate-pulse"></div>
            <div class="relative bg-[#131d31] border border-gray-800 rounded-full p-6 text-brand-green">
    ...
    <!-- Footer Information -->
    <footer class="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-6 border-t border-gray-800/60 pt-8 z-10 text-xs md:text-sm text-gray-500">
        <div>
